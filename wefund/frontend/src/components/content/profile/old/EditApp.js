...
import { getResearch, editResearch } from "../../../actions/researchAction";
import {
...
const EditApp = ({ onEdit, setOnEdit }) => {
  ...
  const { research, errors, isLoading: researchIsLoading } = useSelector(
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <StyledFileUpload
                ...
                name="papers"
                value={
                  papers === "" && research && research.papers
                    ? research.papers.split("/")[3]
                    : papers === ""
                    ? papers
                    : papers.name
                }
