    ...
    return (
      <div>
        ...
        <Table>
          <TableHead>
            <TableRow>
              <TableCell align="right">Id card copy</TableCell>
              <TableCell align="right">date of birth</TableCell>
              <TableCell align="right">degre</TableCell>
            </TableRow>
          </TableHead>
          {   <TableBody>
                     ...
                     {this.props.users.map((user) => (
                            <TableRow key={user.id}>
                                ...
                                <TableCell align="right">{user.id_card_number}</TableCell>
                                <TableCell align="right">{user.id_card_copy}</TableCell>
                                <TableCell align="right">{user.degree}</TableCell>
                                <TableCell align="right">{user.organisation}</TableCell>
                                <TableCell align="right">{user.cv}</TableCell>
                            </TableRow>
                            ))}
                    </TableBody>}
...
const mapStateToProps = (state) => ({users: state.researcher});
export default connect(mapStateToProps, {getUsers})(ListResearchersComponent);